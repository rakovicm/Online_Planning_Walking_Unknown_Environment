...
for i = 1 : incr : ikraj
        ...
        if(ob_c(2)<0)
            ob_c = ob_c_poc + i*d_ob_c;
        end
        
        walls = [   ob_c(1)-ob_w ob_c(2)+ob_w ob_c(1)+ob_w ob_c(2)+ob_w ob_c(1)+ob_w ob_c(2)-ob_w ob_c(1)-ob_w ob_c(2)-ob_w ob_c(1)-ob_w ob_c(2)+ob_w;
                5 4.5 5.2 4.5 5.2 3 5 3 5 4.5];
            
        walls_d = [   ob_c(1)-ob_wd ob_c(2)+ob_wd ob_c(1)+ob_wd ob_c(2)+ob_wd ob_c(1)+ob_wd ob_c(2)-ob_wd ob_c(1)-ob_wd ob_c(2)-ob_wd ob_c(1)-ob_wd ob_c(2)+ob_wd;
                5 4.5 5.2 4.5 5.2 3 5 3 5 4.5];
...
% 
    %         subplot(4,2,[2 4] ,'replace');
            subplot(4,2,[1 2 3 4],'replace');
            hold on;
            draw_fliermirkospec(flier,seg, 'r', 42,[13 21],[14 22],[-0.1 8 -2 2 0 1.9],[0 0 1]);
    %       draw_fliermirkospec(flier,seg, 42,[13 21],[14 22],[-0.1 6 -0.3 3.5 -0.1 1.9],[0 0 1],[],2,cc);
...
%             for pic = 1 : size(putanja_s,3)
%                 plot(putanja_s(1,:,1),putanja_s(2,:,pic),'b');
%             end
%             if(i<0.6*ikraj)
%                 crtaj_zid([0 0 0],walls_d,0.5);
%             else
%                 crtaj_zid([0 0 0],walls_d,1);
%             end
            axis([-0.5 8 -2 1.5 -0.1 1.9]);
%             axis equal;    
...
%         plot(rpetad(1),rpetad(2),'b*');      
        plot(a.ZMPpos(1,i),a.ZMPpos(2,i),'rx');
