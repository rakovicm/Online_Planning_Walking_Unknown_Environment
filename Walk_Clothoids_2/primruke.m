...
% %     r_saka_l_p(1) = rramel(1) + rskzd(1) - rkukd(1)+0.0783;% r_saka_rame_l + r_saka_rame_l_e;
    ...
    rpetal_kor = rpetal(1:3) + rotx(rpetal(4))*rotx(rpetal(5))*rotz(rpetal(6))*[0.1686;-0.28;0];
    rpetad_kor = rpetad(1:3) + rotx(rpetad(4))*rotx(rpetad(5))*rotz(rpetad(6))*[0.1686;0.28;0];
