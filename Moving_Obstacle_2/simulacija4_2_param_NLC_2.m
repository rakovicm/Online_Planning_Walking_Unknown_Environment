...
%     cilj = [1.5+0.5,1.5,pi/2;3+0.5,1.5,0;6+0.5,0,-pi/2;];
    ...
    last_min_distance_index=2;
    last_min_distance_index_D=2;
    last_min_distance_index_L=2;
...
figure(1);
            ...
            draw_fliermirko(flier,seg, 42,[13 21],[14 22],[-0.5 5 -2.5 2.5 -0.1 1.9],[0 0 1],[1:12],2,'rrr');
