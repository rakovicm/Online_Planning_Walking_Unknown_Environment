...
% 
%         hold on;
%         draw_fliermirko(flier,seg, 42,[13 21],[14 22],[rcm(1,i)-1 rcm(1,i)+1 -0.5 0.5 -0.1 1.9],[sin(zelj_p(1,i)) -cos(zelj_p(1,i)) 0],[],2,'rrr');
% %             for pri = 0:0.01:0.1
...
% 
%         hold on;
%         draw_fliermirko(flier,seg, 42,[13 21],[14 22],[rcm(1,i)-1 rcm(1,i)+1 -0.5 0.5 -0.1 1.9],[0 0 1],[],2,'rrr');
...
%         plot(putanja_s(1,:,2),putanja_s(2,:,2),'r');
%         plot(putanja_s(1,:,3),putanja_s(2,:,3),'m');
%         plot(putanja_s(1,:,4),putanja_s(2,:,4),'b');
%         
%         subplot(4,2,[6 8]);
%         hold on;
%         draw_fliermirko(flier,seg, 42,[13 21],[14 22],[rcm(1,i)-1 rcm(1,i)+1 -0.5 0.5 -0.1 1.9],[cos(zelj_p(1,i)) sin(zelj_p(1,i)) 0],[],2,'rrr');
