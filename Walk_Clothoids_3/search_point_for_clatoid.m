function [x y XY] = search_point_for_clatoid(c_pose, goal)
%     
...
% % %                 6 -1.5 6.2 -1.5 6.2 3 6 3 6 -1.5 ]; 
    ...
    while(i<size(walls,1))
        ...
        y_e_2 = yi(i_min);
        wall_i = i;
        if(~isempty(x_e) || d_min(1)<0.2)%Proveriti ovaj uslov
            point_found = 0;
            ...
            dir_e2 = [x_e_1-c_pose(1);y_e_1-c_pose(2);0];
