...
J = [ rs*[1 0 0]' rs*[0 1 0]' rs*[0 0 1]' cross(e(:,1),rp) cross(e(:,2),rp) cross(e(:,3),rp);
		zeros(3) [e(:,1) e(:,2) e(:,3)] ];
J = -inv(J);	% with changing the sign ( dds = Jsl*dds + Jsb*dds + Al + Ab)
				% without it, it should be inv(J)
...
A = J*A;	% with no changing sign ( dds = Jsb*dds + Jsl*dds + Ab + Al)
			% without it, it should be -J*A
