 ...
 */
FARPROC WINAPI k_inematDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = k_inematDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = k_inematDelayLoadWin32FailureHook;
#endif
